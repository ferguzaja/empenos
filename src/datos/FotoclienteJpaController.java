...
public class FotoclienteJpaController implements Serializable {
    ...
    public FotoclienteJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void edit(Fotocliente fotocliente) throws NonexistentEntityException, Exception {
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            Fotocliente persistentFotocliente = em.find(Fotocliente.class, fotocliente.getIdfotoCliente());
            ...
            if (msg == null || msg.length() == 0) {
                Integer id = fotocliente.getIdfotoCliente();
